...
%%%% 31, 32, 42, 43, 45, 90, 97, 101, 102, 103, 104, 105, 107 (c),
%%%%%
...
\begin{problem} %116
  ...
  A general formula can be derived for the factorization of $(a^n -b^n)$ seeing the last few questions.
  ...
  We can also derive the factorization formula for $(a^n + b^n)$ as below.
